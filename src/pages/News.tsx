...
const newsItems = [
  ...
  },
  {
    ...
    date: '2026-01-20',
    category: 'Компания',
    title: 'Rusdoors открыл новый шоурум в Москве',
    excerpt: 'Теперь все модели можно увидеть и потрогать вживую. Наш новый шоурум расположен в самом центре — приходите, мы покажем всё лично.',
    readTime: '2 мин',
    featured: false,
  },
  {
