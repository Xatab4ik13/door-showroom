...
**Отделка.** Для квартирных дверей популярны панели МДФ с покрытием ПВХ или экошпоном — они устойчивы к царапинам и просты в уходе. В верхнем сегменте — натуральный шпон дуба или ореха.
...
**Покрытия:** Экошпон, ПВХ-плёнка, натуральный шпон, эмаль. Для влажных помещений (ванная) выбирайте ПВХ или экошпон — они не боятся влаги. Для гостиной и спальни — натуральный шпон для солидного и тёплого интерьера.
