              ...
              >
                ...
                <motion.div custom={1} variants={fadeUp} className="flex items-start gap-5">
                  ...
                  <div>
                    ...
                    <p className="mt-2 text-muted-foreground leading-relaxed" style={{ fontFamily: "'Manrope', sans-serif" }}>
Доставка межкомнатных дверей назначается по согласованию и подтверждении заказа до 14:30. Доставляем с понедельника по субботу (на субботу доставку необходимо согласовывать минимум за 2 дня).{'\n'}{'\n'}Период доставки: по Москве в пределах МКАД — с 10:00 до 20:00, за МКАД — с 10:00 до 23:00. За час до доставки курьер обязательно свяжется с вами.
                    </p>
                  </div>
                </motion.div>
              </motion.div>
