...
const phoneNumbers = [
  ...
  { label: 'Сервис и установка', number: '+7 (495) 111-22-33' },
];
    ...
    <>
      ...
      <section className="pt-32 md:pt-40 pb-16 md:pb-20 px-4 md:px-8 lg:px-12 max-w-[1600px] mx-auto">
        ...
        >
          ...
          >
            КОНТА<span className="text-[hsl(205,85%,45%)]">К</span>ТЫ
          </h1>
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div className="space-y-6">
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                <div className="w-10 h-10 rounded-xl bg-[hsl(205,85%,45%)]/10 flex items-center justify-center">
                  <Phone className="w-5 h-5 text-[hsl(205,85%,45%)]" />
                </div>
                <h2
                ...
                {phoneNumbers.map((p, i) => (
                  ...
                  >
                    <div>
                      ...
                      <span className="text-lg font-medium text-foreground group-hover:text-[hsl(205,85%,45%)] transition-colors" style={{ fontFamily: "'Manrope', sans-serif" }}>
                        {p.number}
                      </span>
                    </div>
                    <Phone className="w-4 h-4 text-muted-foreground group-hover:text-[hsl(205,85%,45%)] transition-colors" />
                  </motion.a>
                ))}
              </div>
            </motion.div>
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                <div className="w-10 h-10 rounded-xl bg-[hsl(205,85%,45%)]/10 flex items-center justify-center">
                  <MessageCircle className="w-5 h-5 text-[hsl(205,85%,45%)]" />
                </div>
                <h2
                  className="text-xl font-bold uppercase tracking-wider text-foreground"
                  style={{ fontFamily: "'Oswald', sans-serif" }}
              ...
              <div className="grid sm:grid-cols-2 gap-3">
                {messengers.map((m, i) => (
                  <motion.a
                    ...
                    className="group flex items-center gap-4 p-5 rounded-xl border border-border hover:border-[hsl(205,85%,45%)]/30 hover:shadow-md transition-all duration-300"
                  >
                    <div
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                <div className="w-10 h-10 rounded-xl bg-[hsl(205,85%,45%)]/10 flex items-center justify-center">
                  <Mail className="w-5 h-5 text-[hsl(205,85%,45%)]" />
                </div>
                <h2
                  className="text-xl font-bold uppercase tracking-wider text-foreground"
                  style={{ fontFamily: "'Oswald', sans-serif" }}
              ...
              <a
                ...
                className="text-lg text-foreground hover:text-[hsl(205,85%,45%)] transition-colors"
          ...
          <div className="space-y-6">
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                <div className="w-10 h-10 rounded-xl bg-[hsl(205,85%,45%)]/10 flex items-center justify-center">
                  <MapPin className="w-5 h-5 text-[hsl(205,85%,45%)]" />
                </div>
                <h2
                  className="text-xl font-bold uppercase tracking-wider text-foreground"
                  style={{ fontFamily: "'Oswald', sans-serif" }}
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                <div className="w-10 h-10 rounded-xl bg-[hsl(205,85%,45%)]/10 flex items-center justify-center">
                  <Clock className="w-5 h-5 text-[hsl(205,85%,45%)]" />
                </div>
                <h2
                  className="text-xl font-bold uppercase tracking-wider text-foreground"
                  style={{ fontFamily: "'Oswald', sans-serif" }}
            ...
            <motion.div
              ...
              className="relative bg-gradient-to-br from-[hsl(205,85%,45%)] via-[hsl(205,70%,35%)] to-[hsl(215,50%,15%)] rounded-2xl p-8 md:p-10 overflow-hidden"
            >
