          ...
          <div className="max-w-[1600px] mx-auto">
            ...
            >
              ...
              <motion.div custom={1} variants={fadeUp} className="space-y-6">
                ...
                <p className="text-muted-foreground leading-relaxed text-base md:text-lg" style={{ fontFamily: "'Manrope', sans-serif" }}>
                  Мы постоянно расширяем ассортимент и следим за современными тенденциями в производстве дверей. В каталоге представлены модели для любого бюджета — от практичных бюджетных решений до элитных моделей для интерьеров любого стиля.
                </p>
              </motion.div>
            </motion.div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                },
                {
                  ...
                  desc: 'Мы устанавливаем двери ровно, аккуратно, без пыли и хаоса. Качественные двери требуют качественного подхода — и мы его обеспечиваем.',
                },
                {
                  icon: Sparkles,
